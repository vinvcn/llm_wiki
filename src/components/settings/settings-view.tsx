  ...
  return (
    <div className="flex h-full flex-col overflow-hidden md:flex-row">
      ...
      <aside className="flex w-full shrink-0 flex-col border-b bg-muted/30 md:w-56 md:border-b-0 md:border-r">
        <div className="hidden px-4 pb-2 pt-4 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground md:block">
          {t("settings.title")}
        </div>
        <nav className="flex flex-row gap-1 overflow-x-auto overflow-y-hidden px-2 py-2 md:flex-1 md:flex-col md:overflow-y-auto md:overflow-x-hidden md:pb-3">
          {CATEGORIES.map((c) => {
            const Icon = c.icon
            ...
            return (
              <button
                ...
                className={`group mb-0.5 flex shrink-0 items-center gap-2.5 rounded-md px-2.5 py-1.5 text-sm transition-colors md:w-full ${
                  isActive
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        {active !== "about" && active !== "llm" && (
          <div className="shrink-0 border-t bg-background/80 backdrop-blur px-4 py-3 md:px-8">
